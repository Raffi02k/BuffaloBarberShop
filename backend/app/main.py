"""Buffalo Barbershop API. Run: uvicorn app.main:app --reload"""
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app = FastAPI(title="Buffalo Barbershop API", version="1.0.0", docs_url="/api/docs", redoc_url=None, openapi_url="/api/openapi.json")
